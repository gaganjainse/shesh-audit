"""shesha-audit: append-only, hash-chained event log + policy gate.

This is the Brain's conscience. Every action Shesha takes is recorded as an
...
be the foundation that SheshaAOS-style governance plugs into later.
"""
